...
def load_config(mapping_path: str) -> CollectorConfig:
    ...
    netbox_cfg = NetBoxConfig(
        ...
        retry_initial_delay=_float(_eval_config_str(netbox_body.get("retry_initial_delay", "env('NETBOX_RETRY_INITIAL_DELAY', '0.3')")), default=0.3),
        retry_backoff_factor=_float(_eval_config_str(netbox_body.get("retry_backoff_factor", "env('NETBOX_RETRY_BACKOFF_FACTOR', '2.0')")), default=2.0),
