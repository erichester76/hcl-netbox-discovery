...
class TestCatcMappings:
    ...
    @staticmethod
    def _device_object(cfg: Any) -> Any:
    ...
    def test_device_fields_reference_prereqs(self, mapping_path):
        ...
        assert field_values.get("device_type") == "prereq('device_type')"
        assert "site" in field_values and "prereq('site')" in field_values["site"]
